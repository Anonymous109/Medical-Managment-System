...
export class OperationReportsComponent implements OnInit {
  ...
  operationReports: Observable<Array<any>>;
  ...
  getOperationReports() {
    ...
    this.api.get('/operationReports').subscribe(data => {
      this.operationReports = Observable.interval(10).map(i => data);
      return false;
    });
  }

  download(operationReportsDisplay: any) {
    ...
    for(var i =0 ; i < operationReportsDisplay.reports.length; i++)
    {
      this.operationReportHistory += ("\n\n\nOperation Time : " + operationReportsDisplay.reports[i].operationTime + "   \n" +
                                      "Operation Reason : " + operationReportsDisplay.reports[i].reason + "    \n" + 
                                      "Operated Doctor : " + operationReportsDisplay.reports[i].doctorUserName + " \n"  
                                );
    }
