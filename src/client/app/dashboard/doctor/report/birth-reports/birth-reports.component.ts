...
export class BirthReportsComponent implements OnInit {
  ...
  download(birthReportsDisplay: any) {
    var dd = {
      ...
      content: [
        ...
        { text: 'Birth Certificate', style: 'header' },
        { text: birthReportsDisplay.childName + "                     Sex : " + birthReportsDisplay.gender, style: 'anotherstyle' },
        { text: "Mother Full Name    : " + birthReportsDisplay.motherFullName, style: 'anotherstyle' },
        { text: "Father Full Name    : " + birthReportsDisplay.fatherFullName, style: 'anotherstyle' },
        { text: "Date OF Birth       : " + birthReportsDisplay.birthDate, style: 'anotherstyle' },
        { text: "Time        : " + birthReportsDisplay.birthTime, style: 'anotherstyle' },
        { text: "Weight of Child at Birth      : " + birthReportsDisplay.weightOfChild + " Length    : " + birthReportsDisplay.length + "    Width Between Shoulders       : " + birthReportsDisplay.widthBetweenShoulders, style: 'anotherstyle' },
        { text: "Name of Attending Doctor : " + birthReportsDisplay.attendingDoctor, style: 'anotherstyle' }
      ],
      style: {
        imageMine: {
          alignment: 'center'
